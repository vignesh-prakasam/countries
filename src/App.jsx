  ...
  return (
    <>
      ...
      >
        ...
        >
          {isDarkMode ? (
            <i class="fa-solid fa-moon mr-1 px-1"></i>
          ) : (
            <i class="fa-regular fa-moon mr-1 px-1"></i>
          )}
          Dark Mode
        </button>
      </header>
      ...
      >
        ...
        <div className="flex sm:flex-row flex-col sm:justify-between justify-start sm:mb-0">
          ...
          <i class=" absolute top-12 left-4 fa-solid fa-magnifying-glass text-gray-400"></i>
            <input
              type="text"
              name="country"
              id="country"
